...
public class frm_calzadoHombre extends JFrame {
	...
	public frm_calzadoHombre() {
		...
		btnDeportivas.setBounds(39, 275, 273, 143);
		...
		btnCasual.setBounds(39, 58, 273, 143);
		contentPane.add(btnCasual);
		
		JButton btnMocasines = new JButton("Mocasines");
		btnMocasines.setFont(new Font("Tahoma", Font.PLAIN, 30));
		btnMocasines.setBounds(364, 58, 273, 143);
		contentPane.add(btnMocasines);
		
		JButton btnBotas = new JButton("Botas");
		btnBotas.setFont(new Font("Tahoma", Font.PLAIN, 30));
		btnBotas.setBounds(364, 275, 273, 143);
